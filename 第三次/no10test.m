...
B(index)=1
C(index)=2
D(index)=(-3.0833*givenPoint(index)+0.6667*givenPoint(index+1) ...
+3*givenPoint(index+2)-0.6667*givenPoint(index+3)+0.0833*givenPoint(index+4))/h
...
B(index)=1
C(index)=0
D(index)=-1*(-3.0833*givenPoint(index)+0.6667*givenPoint(index-1) ...
+3*givenPoint(index-2)-0.6667*givenPoint(index-3)+0.0833*givenPoint(index-4))/h
